...
OUT_DIR = ROOT / "output" / "diagnostics" / "typical_explicit_no_stop"
CONFIG_PATH = OUT_DIR / "typical_L322P8_H10P48_U0P6_explicit_force_no_stop.yaml"
...
def main() -> None:
    ...
    cfg["event_stop"] = {
        "enabled": False,
        "rationale": "Disabled for natural OpenSees continuation/failure observation.",
    }
    cfg["solver"]["opensees_path"] = r"D:\Pyprogramme\OpenSees3.8.0\bin\OpenSees.exe"
    cfg["paths"]["output_dir"] = "output/diagnostics/typical_explicit_no_stop/run"
    cfg["paths"]["save_prefix"] = "TYPICAL_EXPLICIT_NO_STOP"
